...
public class OkhttpUtils {
    ...
    /*登录获取验证号码*/
    public static final String CAPTCHA = "/user/login/GetSmsCode";
    /*注册获取验证码*/
    ...
    /*根据房间号修改房间信息*/
    public static final String UpdateRoom = "/voiceCall/updateRoom";
    /*根据房间号删除房间*/
    ...
    /*获取音频*/
    public static final String GetAudio = "/audio/manage";
    /*获取评论*/
    public static final String listComment = "/comment/manage/list";
    /*获取评论加载文件*/
    public static final String CommentFile = "/file/manage";
    /*根据手机号获取设备信息*/
    public static final String GetDeviceByPhone = "/device/getByPhone";
    /*新增设备*/
    public static final String AddDevice = "/device/insertDevice";
    /*获取设备ip*/
    public static final String getDevice = "/device/report/list";
    /*修改设备状态*/
